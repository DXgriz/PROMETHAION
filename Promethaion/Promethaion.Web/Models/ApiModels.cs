namespace Promethaion.Web.Models
{
    public class ApiModels
    {
        ...
        public record BallScoreDto(int Ball, double Score, int Rank);

        public record AddPatternEventDto(
            int DrawNumber,
            DateTime DrawDate,
            int Ball1, int Ball2, int Ball3, int Ball4, int Ball5, int Ball6,
            int? BonusBall,
        ...
        public record AccuracyDto(double RollingAccuracy, bool ShouldRetrain, int Window);
    }
}
